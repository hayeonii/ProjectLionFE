...
// function -> await 비동기 : 안됨
// async function -> await 비동기 : 됨
// 예외적으로 await이 밖에 감싸여진 함수 없이 사용될 수 있는 것 : top-level-await (작동함, 생긴지 얼마 안 됨)
...
const z = 100
function sum(a, b){return a + b + z} // z -> 렉시컬환경으로 인해 스코프체인이 일어난다
