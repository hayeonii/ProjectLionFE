...
("puallab CEO leehojun hello CEO").replace(/CEO/, "CTO");
// 'puallab CTO leehojun hello CEO'
// 앞은 수정 되는데 되는 안바뀜

("puallab CEO leehojun hello CEO").replace(/CEO/g, "CTO");
// 'puallab CTO leehojun hello CTO'
// 글로벌하게 쓰겠다

("puallab CEO leehojun hello CEO").match(/CEO/g);
("puallab CEO leehojun hello CEO").split(/CEO/g);
(/CEO/g).test("puallab CEO leehojun hello CEO");
...
// 7. 범위
/h[a-zA-Z0-9]llo/g // 대괄호는 하나만 매핑함
...
/(?:on|ues)/gm // 그룹을 설정하지 않겠다
/(on|ues)|(rida)/gm // 그룹1(on|ues)과 그룹2(rida)로 각각 매칭되는 패턴 찾음
/.(a|e|o)ll./gm // h[eao]llo과 탐색 결과 같음
/hello (?!world)/gm // hello 뒤에 world가 오지 않는 것 negatavie 매칭
/hello (?=world)/gm // hello 뒤에 world가 오는 것 positive 매핑
// 그룹을 사용하는 이유는 그룹으로 매핑하면 0번째 1번째 이렇게 찾을 수 있다
// 결과가 그룹으로 묶임
