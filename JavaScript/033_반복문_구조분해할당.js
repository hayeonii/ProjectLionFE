...
for (i in value2) { // for of로 순회를 돌 수 없음
    console.log(i)
}

for (i of value2) { // of로 순회를 돌아야 key와 value를 한꺼번에 출력 가능한데 불가능함 // error
    console.log(i)
}
...
let one, two , three;
[one, two, three] = '010-9894-5501'.split('-');

let one1, two1, three1, four1;
[one1, two1, three1, four1] = '010-9894-5501-0000'.split('-');

let one2, two2, three2, four2;
[one2, two2, three2, ...four2] = '010-9894-5501-0000-01-02-03'.split('-');
...
let a2 =[1, 2, 3]
let b2 = [10, 20, 30]
let c2 = [...a2, ...b2] // 이렇게 합쳐진 값을 다시 구조분해할당
